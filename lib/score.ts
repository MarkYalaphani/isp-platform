...
export function getScorePoint(metric: string, val: string | number, dob: string): number {
  ...
  if (age <= 8) {
    switch (metric) {
      case 'speed30':   return v <= 6.00 ? 5 : v <= 6.50 ? 4 : v <= 7.00 ? 3 : v <= 7.50 ? 2 : 1;
      case 'cmj':       return v >= 22 ? 5 : v >= 18 ? 4 : v >= 14 ? 3 : v >= 10 ? 2 : 1;
      case 'agility':   return v <= 21.50 ? 5 : v <= 23.00 ? 4 : v <= 24.50 ? 3 : v <= 26.00 ? 2 : 1;
      case 'situp':     return v >= 20 ? 5 : v >= 16 ? 4 : v >= 12 ? 3 : v >= 8 ? 2 : 1;
      case 'pushup':    return v >= 14 ? 5 : v >= 10 ? 4 : v >= 7 ? 3 : v >= 4 ? 2 : 1;
      case 'longjump':  return v >= 130 ? 5 : v >= 115 ? 4 : v >= 100 ? 3 : v >= 85 ? 2 : 1;
      case 'yoyo':      return v >= 400 ? 5 : v >= 280 ? 4 : v >= 160 ? 3 : v >= 80 ? 2 : 1;
      case 'sitreach':  return v >= 18 ? 5 : v >= 12 ? 4 : v >= 6 ? 3 : v >= 0 ? 2 : 1;
    }
  ...
  // ─────────────────────────────────────────────────────────────────
    ...
    switch (metric) {
      case 'speed30':   return v <= 5.70 ? 5 : v <= 6.10 ? 4 : v <= 6.50 ? 3 : v <= 6.90 ? 2 : 1;
      case 'cmj':       return v >= 25 ? 5 : v >= 20 ? 4 : v >= 16 ? 3 : v >= 12 ? 2 : 1;
      case 'agility':   return v <= 20.50 ? 5 : v <= 22.00 ? 4 : v <= 23.50 ? 3 : v <= 25.00 ? 2 : 1;
      case 'situp':     return v >= 23 ? 5 : v >= 18 ? 4 : v >= 14 ? 3 : v >= 10 ? 2 : 1;
      case 'pushup':    return v >= 15 ? 5 : v >= 12 ? 4 : v >= 8 ? 3 : v >= 5 ? 2 : 1;
      case 'longjump':  return v >= 145 ? 5 : v >= 130 ? 4 : v >= 115 ? 3 : v >= 100 ? 2 : 1;
      case 'yoyo':      return v >= 560 ? 5 : v >= 400 ? 4 : v >= 240 ? 3 : v >= 120 ? 2 : 1;
      case 'sitreach':  return v >= 19 ? 5 : v >= 13 ? 4 : v >= 7 ? 3 : v >= 1 ? 2 : 1;
    }
  ...
  // ─────────────────────────────────────────────────────────────────
    ...
    switch (metric) {
      case 'speed30':   return v <= 5.40 ? 5 : v <= 5.80 ? 4 : v <= 6.20 ? 3 : v <= 6.60 ? 2 : 1;
      case 'cmj':       return v >= 27 ? 5 : v >= 22 ? 4 : v >= 18 ? 3 : v >= 13 ? 2 : 1;
      case 'agility':   return v <= 19.50 ? 5 : v <= 21.00 ? 4 : v <= 22.50 ? 3 : v <= 24.00 ? 2 : 1;
      case 'situp':     return v >= 25 ? 5 : v >= 20 ? 4 : v >= 16 ? 3 : v >= 11 ? 2 : 1;
      case 'pushup':    return v >= 16 ? 5 : v >= 12 ? 4 : v >= 9 ? 3 : v >= 5 ? 2 : 1;
      case 'longjump':  return v >= 158 ? 5 : v >= 143 ? 4 : v >= 128 ? 3 : v >= 113 ? 2 : 1;
      case 'yoyo':      return v >= 640 ? 5 : v >= 480 ? 4 : v >= 320 ? 3 : v >= 160 ? 2 : 1;
      case 'sitreach':  return v >= 19 ? 5 : v >= 13 ? 4 : v >= 7 ? 3 : v >= 1 ? 2 : 1;
    }
...
export const SCORE_BENCHMARKS: Record<string, {
  ...
  speed30: {
    ...
    groups: [
      { age: '8–12',  s5: '<5.00', s4: '5.00–5.40', s3: '5.40–5.80', s2: '5.80–6.20' },
  ...
  cmj: {
    ...
    groups: [
      { age: '8–12',  s5: '≥32', s4: '27–32', s3: '22–27', s2: '17–22' },
  ...
  yoyo: {
    ...
    groups: [
      { age: '8–12',  s5: '≥840',  s4: '640–840',  s3: '400–640',  s2: '200–400' },
