...
export type Page = 'home' | 'dashboard' | 'roster' | 'scout' | 'scoutcard' | 'ir' | 'skill' | 'attendance' | 'training' | 'performance' | 'register' | 'adminUsers' | 'teamreport' | 'compare' | 'quicktest' | 'migrate' | 'lineup' | 'wellness' | 'tester' | 'help' | 'leaderboard' | 'batchadd' | 'matchlog' | 'calendar' | 'goals' | 'monitor' | 'nutrition' | 'nutritionPlanner' | 'tactics';
