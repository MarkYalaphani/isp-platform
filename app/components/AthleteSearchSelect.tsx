...
export default function AthleteSearchSelect({
  ...
  const borderColor = open ? (accentColor || '#38bdf8') : value ? (accentColor || '#38bdf8') : '#e2e8f0';
    ...
    <div ref={wrapRef} style={{ position: 'relative' }}>
      ...
      {open && (
        <div style={{
          ...
          zIndex: 2000, background: 'var(--surface)',
              ...
              filtered.map(a => {
                ...
                return (
                  <div
                    ...
                    onMouseLeave={e => { if (!isSel) (e.currentTarget as HTMLElement).style.background = isSel ? 'rgba(56,189,248,0.08)' : 'transparent'; }}
                  >
                    <div style={{
